...
/** @var backend\models\Search\SubjectsSearch $searchModel */
    ...
    <div class="classes-index" style="background-color: #F6F7FB">
        ...
        <div class="row mt-3 ps-1 ">
                ...
                <div class="stats-card col-md-6 col-xl-3 bg-transparent p-2">
                    <div class="position-relative bg-white p-4 rounded-4">
                        <div class="card-header-custom">
                            <h6 class="card-title fs-2 text-[#2b3d51]"><?= Html::encode($class->name) ?></h6>
                            <div class="card-actions align-items-center">
                                <a href="<?= Url::to(['subjects/update', 'id' => $class->id]) ?>" class="fs-2">
                                ...
                                <form action="<?= Url::to(['subjects/delete', 'id' => $class->id]) ?>" method="post" style="display:inline;">
                        ...
                        <div class="students-count d-flex align-items-center">
                            ...
                            <div class="d-inline-block p-2 border-end ">
                                <span class="fs-4 fw-bolder">1</span>
                                <br>
                                <span class="text-[#666]" style="font-size: 12px">TOTAL SUBJECTS</span>
                            </div>
                            <div class="d-inline-block p-2 ">
                                <span class="fs-4 fw-bolder">10</span>
                                <br>
                                <span class="text-[#666]" style="font-size: 12px">TOTAL EXAM MARKS</span>
                            </div>
                            <i class="fa-solid fa-folder fs-2 text-[#3144de]"></i>
                        </div>
            ...
            <div class="col-md-6 col-xl-3">
                <a href="<?= yii\helpers\Url::to(['/subjects/create']) ?>">
