...
$this->title = 'Fee Invoices';
$this->registerCssFile(Yii::getAlias('@web/js/tables/plugin/').'jquery.dynatable.css', [
        'position' => \yii\web\View::POS_BEGIN]);
$this->registerCssFile(Yii::getAlias('@web/js/tables/plugin/').'rowReorder.dataTables.min.css', [
        'position' => \yii\web\View::POS_BEGIN]);
$this->registerCssFile(Yii::getAlias('@web/js/tables/plugin/').'responsive.datatables.min.css', [
        'position' => \yii\web\View::POS_BEGIN
]);
?>
<div class="fee-invoices-index">
    <?php $this->beginBody();?>
